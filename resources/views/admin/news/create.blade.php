                    ...
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        <textarea class="form-control" name="n_solder" placeholder="News Solder"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        <textarea class="form-control n_head" name="n_head" required="true" placeholder="News Headline" required></textarea>
                                    </div>
                                    <div id="n_head" class="text-danger">
                                        <span id="current_count1">0</span>
                                        <span id="maximum_count1">/ 60</span>
                                        <small>৫০ থেকে ৬০ অক্ষররের মধ্যে সীমিত রাখুন। - গুগল</small>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        <textarea class="form-control" name="n_subhead" placeholder="News Sub Headline"></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        <input type="text" name="meta_keyword" class="form-control"
                                            placeholder="keywords" style="height:50px" required
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <select class="form-control _select2" name="parent_id">
                                                    <option value="0">Select Parent News</option>
                                                    @foreach ($livenewsSql as $lrow)
                                                        <option value="{{ $lrow->n_id }}"
                                                            @if (Request::get('nid') == $lrow->n_id) selected @endif>
                                                            {{ $lrow->n_head }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="n_author"
                                                        value="নিজস্ব প্রতিবেদক" required data-rule-required="true">
                                                    নিজস্ব প্রতিবেদক
                                                    <span class="circle"><span class="check"></span></span>
                                                </label>
                                            </div>
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            <div class="row">
                                        ...
                                        <div>
                                            <span class="btn btn-rose btn-round btn-file">
                                                ...
                                                <input type="file" name="main_image"
                                                    @if (Request::get('edition') == 'online') required @endif />
                                            </span>
                                ...
                                <div class="col-md-8">
                                    @php $getWatermarkAd = str_replace('"', '', $activeWatermarkAd->arr_data) @endphp
                                    <div class="row">
                                        <label class="col-sm-4 col-form-label label-checkbox">

                                            @if ($getWatermarkAd != 0)
                                                <div class="bg-danger text-white">Global Watermark Ad</div>
                                            @else
                                                Watermark Ad
                                            @endif
                                        </label>
                                        <div class="col-md-8 pull-right">
                                            <select class="form-control _select2" data-style="select-with-transition"
                                                title="No ad" data-size="7" name="watermark">
                                                <option value="">No ad</option>
                                                @if ($watermark_ads)
                                                    @foreach ($watermark_ads as $wtrow)
                                                        @if (Request::get('edition') == 'online')
                                                            @if ($getWatermarkAd == 0)
                                                                <option value="{{ $wtrow->id }}"
                                                                    @if ($wtrow->id == Auth::user()->watermark_ad) selected @endif>
                                                                    {{ $wtrow->name }}
                                                                </option>
                                                            @else
                                                                <option value="{{ $wtrow->id }}"
                                                                    @if ($wtrow->id == $getWatermarkAd) selected @endif>
                                                                    {{ $wtrow->name }}
                                                                </option>
                                                            @endif
                                                        @else
                                                            <option value="{{ $wtrow->id }}">{{ $wtrow->name }}
                                                            </option>
                                                        @endif
                                                    @endforeach
                                                @endif
                                        ...
                                        <div class="col-sm-10 checkbox-radios">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input" type="radio" name="n_caption"
                                                            value="সংগৃহীত ছবি" required> সংগৃহীত ছবি
                                                        <span class="circle"><span class="check"></span></span>
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                            ...
                                            <textarea class="form-control" name="n_caption_txt" placeholder="Caption..."></textarea>
                                        </div>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group">
                                                <textarea id="embed_code" class="form-control" cols="8" name="embedded_code"></textarea>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="col-sm-10 checkbox-radios">
                                                <div class="form-check form-check-inline">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input" type="radio" name="main_video"
                                                            value="1"> Main Video
                                                        <span class="circle">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input" type="radio" name="main_video"
                                                            value="2"
                                                            @if (Request::get('edition') == 'multimedia') checked @endif>Content Video
                                                        <span class="circle">
                                                            <span class="check"></span>
                                                        </span>
                                                    </label>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input" type="radio" name="main_video"
                                                            value="0"
                                                            @if (Request::get('edition') != 'multimedia') checked @endif> No video
                                                        <span class="circle">
                                                            <span class="check"></span>
                                                        </span>
                                                    </label>
                        ...
                        <div class="card-body">
                                            ...
                                            @foreach ($menus as $Mrow)
                                                @if ($Mrow->slug != '#')
                                                    <option value="{{ $Mrow->m_id }}"
                                                        @if (Request::get('mid') == $Mrow->m_id) selected @endif>
                                                        {{ $Mrow->m_name }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 checkbox-radios">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <select name="home_lead_sort" class="form-control">
                                            <option disabled selected value="0">Position</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 checkbox-radios">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <select name="highlight_sort" class="form-control">
                                            <option disabled selected value="0">Position</option>
                                            <option value="0">1</option>
                                            <option value="1">2</option>
                                            <option value="2">3</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 checkbox-radios">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="sticky"
                                                value="1"> yes
                                            <span class="circle"><span class="check"></span></span>
                                        </label>
                                    </div>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ $newsdate }} 00:00:00" name="start_at" readonly>
                                                </div>
                                            </div>
                                            <label class="col-sm-2 label-on-right"><code>*</code></label>
                                        </div>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    <input type="text" class="form-control datetimepicker"
                                                        placeholder="Start publishing" name="start_at" value="">
                                                </div>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" type="radio"
                                                                    name="n_status" value="3" checked> Publish
                                                                <span class="circle"><span class="check"></span></span>
                                                            </label>
                                                        </div>
                                                    @else
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" type="radio"
                                                                    name="n_status" value="2" checked> Save
                                                                <span class="circle"><span class="check"></span></span>
                                                            </label>
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" type="radio"
                                                                name="n_status" value="0"> Inactive
                                                            <span class="circle"><span class="check"></span></span>
                                                        </label>
                                                    </div>
                                                </div>
