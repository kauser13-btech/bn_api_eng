	...
	<div class="col-md-12">
		...
		<div class="card">
			<div class="card-header card-header-primary card-header-icon">
				...
				<h4 class="card-title">Tag Manager <button class="btn btn-primary btn-round pull-right" data-toggle="modal" data-target="#Writers">Add New</button></h4>
			</div>
			<div class="card-body">
				<div class="material-datatables">
					<table class="table table-striped table-no-bordered table-hover datatables" cellspacing="0" width="100%" style="width:100%">
						...
						<tbody>
							@foreach($list as $row)
							<tr>
								<td class="text-info">{{ $row->id }}</td>
								<td class="text-info">
									@if($row->img!='')
										<img src="{{ \App\Helpers\ImageStoreHelpers::showImage('tag',$row->created_at,$row->img) }}" width="50" alt="Ad Image">
									@endif
								</td>
									...
									<div class="modal fade" id="writers-{{ $row->id }}" tabindex="-1" role="dialog" aria-labelledby="WritersLabel" aria-hidden="true">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form class="form-horizontal" action="{{ url('admin/tag/update/'.$row->id) }}" method="POST" enctype="multipart/form-data">
													@csrf
																...
																<div class="form-group">
																	<div class="fileinput fileinput-new text-center" data-provides="fileinput">
																		<div class="fileinput-new thumbnail img-circle">
																			<img src="{{ \App\Helpers\ImageStoreHelpers::showImage('tag',$row->created_at,$row->img) }}" alt="Ad Image">
																		</div>
...
<div class="modal fade" id="Writers" tabindex="-1" role="dialog" aria-labelledby="WritersLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" action="{{ url('admin/tag/store') }}" method="POST" enctype="multipart/form-data">
				@csrf
				<div class="modal-body">
					<div class="row">
						<label class="col-sm-2 col-form-label">Name</label>
...
@push('breadcrumbs') Tag Manager @endpush
