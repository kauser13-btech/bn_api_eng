	...
	<div class="col-md-12">
		...
		<div class="card">
			<div class="card-header card-header-primary card-header-icon">
				...
				<h4 class="card-title">Astrology List <a href="{{ url('admin/astrology/create') }}" class="btn btn-primary btn-sm pull-right">Add New</a></h4>
			</div>
			<div class="card-body">
								...
								<tr>
									...
									<td>
										...
										@elseif($row->p_status==2)
											<span class="badge badge-pill badge-warning">Save</span>
										@else
									...
									<td class="text-right">
										<a href="{{ url('admin/astrology/'.$row->id.'/edit') }}" class="btn btn-link btn-warning btn-just-icon edit"><i class="material-icons">edit_note</i></a>
										<form class="pull-right" method="POST" action="{{ route('astrology.destroy', $row->id) }}">
											@csrf @method('DELETE')
