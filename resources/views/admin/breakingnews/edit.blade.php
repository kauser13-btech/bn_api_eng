...
<form class="form-horizontal" action="{{ route('breakingnews.update', $row->id) }}" method="POST">
	@csrf
	@method('PATCH')
	<div class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-sm-9">
								<div class="form-group">
									<textarea class="form-control" name="text" rows="5" cols="50">{!! $row->text !!}</textarea>
								</div>
							</div>
						</div>
					...
					<div class="card-body ">
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-sm-8">
									<div class="form-group">
										<input name="start_at" type="text" class="form-control datetimepicker" placeholder="Start publishing" value="{{ $row->start_at }}">
									</div>	
								</div>
						...
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-sm-8">
									<div class="form-group">
										<input name="end_at" type="text" class="form-control datetimepicker" placeholder="End publishing" value="{{ $row->end_at }}">
									</div>	
								</div>
								<label class="col-sm-2 label-on-right"><code>required</code></label>
							</div>
										...
										<div class="form-group">
											<div class="form-check">
												<label class="form-check-label">
													<input class="form-check-input" type="radio" name="b_status" value="1" @if($row->b_status==1) checked @endif> Active
													<span class="circle"><span class="check"></span></span>
												</label>
											</div>
											<div class="form-check">
												<label class="form-check-label">
													<input class="form-check-input" type="radio" name="b_status" value="0" @if($row->b_status==0) checked @endif> Inactive
													<span class="circle"><span class="check"></span></span>
												</label>
											</div>
										</div>
