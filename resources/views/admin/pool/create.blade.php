...
<form class="form-horizontal" action="{{ route('pool.store') }}" method="POST">
	@csrf
				...
				<div class="card ">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-sm-8">
								<div class="form-group">
									<input type="text" class="form-control" name="option_1" value="হ্যাঁ">
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-sm-8">
								<div class="form-group">
									<input type="text" class="form-control" name="option_2" value="না">
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-sm-8">
								<div class="form-group">
									<input type="text" class="form-control" name="option_3" value="মতামত নেই">
								</div>
							</div>
						</div>
					...
					<div class="card-body ">
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-sm-8">
									<div class="form-group">
										<input name="start_date" type="text" class="form-control datetimepicker" placeholder="Start publishing" value="{{ date('Y-m-d H:i:s') }}">
									</div>	
								</div>
										...
										<div class="form-group">
											<div class="form-check">
												<label class="form-check-label">
													<input name="p_status" class="form-check-input" type="radio" value="1" checked> Active
